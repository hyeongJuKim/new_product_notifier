...
# URL을 열어서 html로 파싱한다.
res = urlopen('http://www.bazal.co.kr/product/search.html?view_type=&supplier_code=&category_no=&keyword=%28250%29&product_price1=&product_price2=&order_by=recent&x=138&y=19').read()
